...
class Main(object):
    def __init__(self):
        ...
        self.obr_frame = LabelFrame(self.root, text='nacteni obrazku', padx=5, pady=5)
        self.obr_frame.grid(row=0, column=0)
        self.obr_button = Button(self.obr_frame, text='zobraz obrazek', command=self.open_image)
        ...
        self.work_choose_combobox = ttk.Combobox(self.root, state='readonly')
    ...
    def color(self):
        ...
        self.color_label = Label(self.root, text="tolerance barvy")
        self.color_label.grid(row=0, column=3)
        self.color_tolerance_picker = Scale(self.root, from_=0, to=150, orient=HORIZONTAL, command=self.pick_tolerance)
        self.color_tolerance_picker.set(75)
        self.color_tolerance_picker.grid(row=1, column=3)
